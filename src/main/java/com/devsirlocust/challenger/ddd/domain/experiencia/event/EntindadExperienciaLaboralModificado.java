...
@Getter
public class EntindadExperienciaLaboralModificado extends DomainEvent{
    ...
    public EntindadExperienciaLaboralModificado(ExperienciaLaboralId entityId, ConocimientosAdquiridos conocimientosAdquiridos, Institucion institucion, Periodo periodo) {
