...
import com.devsirlocust.challenger.ddd.domain.experiencia.event.ExperienciaLaboralEliminada;
...
@Getter
public class AgregarExperienciaLaboral implements Command {
  ...
  public AgregarExperienciaLaboral(ExperienciaId experienciaId , ExperienciaLaboralId experienciaLaboralId , ConocimientosAdquiridos conocimientosAdquiridos, Institucion institucion , Periodo periodo){
